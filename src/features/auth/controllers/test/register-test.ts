...
import * as uploadToCloud from '@globals/helpers/cloudinary-upload';
...
describe('RegisterController', () => {
  ...
  it('should throw an error if username is not available', () => {
    ...
    RegisterController.prototype.createAccount(req, res).catch((error: CustomError) => {
  ...
  it('should set session data for valid credentials and send correct json response', async () => {
    ...
    jest
      .spyOn(uploadToCloud, 'uploadToCloud')
      .mockImplementation((): any => Promise.resolve({ version: '1234737373', public_id: '123456' }));

    await RegisterController.prototype.createAccount(req, res);
